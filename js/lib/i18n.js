...
(function (w) {
  ...
  const AR = {
    ...
    'Vos informations personnelles et votre identité': 'معلوماتك الشخصية و هويّتك',
    'Identité': 'الهوية',
    'Photo de profil': 'صورة الحساب',
    'Téléphone': 'الهاتف',
    'Email': 'البريد الإلكتروني',
    'Mot de passe': 'كلمة السر',
    'Sécurité': 'الأمان',
    'Modifier mon mot de passe, vérifié par email':
      'تغيير كلمة السر، بالتأكيد عبر البريد',
    'Adresses de livraison': 'عناوين التوصيل',
    'Ma zone': 'منطقتي',
    'Mon quartier de livraison': 'حيّ التوصيل',
    'Supprimer': 'حذف',
    'Supprimer cette adresse ?': 'حذف هذا العنوان ؟',
    'Se déconnecter ?': 'تسجيل الخروج ؟',
    'Déconnexion': 'تسجيل الخروج',
    'Vous devrez vous reconnecter pour continuer.':
      'لازم تعاود تسجيل الدخول باش تكمّل.',
    'Compte créé le': 'الحساب أُنشئ في',
    'Statut livreur': 'حالة الموزّع',
    'En attente de validation': 'في انتظار التحقّق',
    'Validé': 'مُصادق عليه',
    'Refusé': 'مرفوض',
    'Client': 'عميل',
    'Livreur': 'موزّع',
    ...
    'Assistance': 'المساعدة',
    'Une question, un problème sur une commande': 'سؤال، أو مشكل في طلب',
